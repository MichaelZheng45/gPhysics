...
public class ForceGenerator
{
    ...
    public static float GenerateForce_Torque(Vector2 appliedForce, Vector2 centerOfMass, Vector2 point)
    {
        //t= px*fy - pyfx
        Vector2 arm = (point - centerOfMass);
        float f_torque = (arm.x*appliedForce.y) - (arm.y*appliedForce.x);
